...
1. Read `belief-ledger-pramana-hermes-plugin-plan.md` and
   `belief-ledger-pramana-spec-v0.1.md` completely before implementation.
...
7. Preserve the plan and specification; semantic deviations require an ADR.
