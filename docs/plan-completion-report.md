...
|---|---|---|---|
| Commit | `3d21ccddce66a9659f3509cc1b5758a025541c52` | `c0e1bff` (+ this report) | 10 commits |
| Tests | 353 passed, 0 failed, 0 skipped | 581 passed, 0 failed, 0 skipped | **+228** |
...
| Full `pytest` wall clock | 20.96 s | 29.88 s | +8.9 s for +228 tests |
...
| 723 | `belief_ledger_pramana/hermes/cli.py` | 508 |
...
now prevents any of them growing further.
...
Twenty-four entries, reproduced in full in [plan-findings.md](plan-findings.md). The ones worth
reading first:
