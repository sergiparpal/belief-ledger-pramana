...
| §4.2 recency at full precision ([ADR 0016](adr/0016-full-precision-recency-key.md)) | `engine/priority.py:_recency_micros` | `tests/unit/test_recency_priority.py::test_a_sub_second_gap_decides_wherever_the_second_boundary_falls`, `::test_distinct_instants_never_share_a_rank_at_any_epoch` |
